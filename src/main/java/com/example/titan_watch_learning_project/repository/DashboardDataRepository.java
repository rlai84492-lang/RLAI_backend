...
////    }
////
////    // ── Activity Feed (All flows) ─────────────────────────────────
////    public List<DashboardResponse.ActivityEventDto> findRecentActivity() {
////        return findRecentActivityByFlow(null);
////    }
////
////    // ── Activity Feed (Flow-wise) ─────────────────────────────────
////    public List<DashboardResponse.ActivityEventDto> findRecentActivityByFlow(String flow) {
////        String stepFilter;
////        Object[] params;
////
...
////        }
////
////        // ← button_payload ki shart hata di — ab har activity dikhegi
////        //    (template sent, delivered, user reply, button click — sab)
////        String sql =
////                "SELECT " +
////                        "    m.phone, m.direction, m.message_content, " +
////                        "    m.button_payload, m.sent_at, " +
...
////    public long countDeliveredMessages(String flow) {
////        try {
...
////            return count != null ? count : 0L;
////        } catch (Exception e) {
////            log.warn("Could not count delivered messages: {}", e.getMessage());
////            return 0L;
////        }
////    }
////
////    // ── Sent Messages Count ───────────────────────────────────────
////    public long countSentMessages(String flow) {
////        try {
////            String pattern = flowToPattern(flow);
////            String sql =
////                    "SELECT COUNT(*) FROM messages m " +
...
////            return count != null ? count : 0L;
////        } catch (Exception e) {
////            log.warn("Could not count sent messages: {}", e.getMessage());
////            return 0L;
////        }
////    }
////
...
//    private static final DateTimeFormatter ISO = DateTimeFormatter.ISO_LOCAL_DATE_TIME;
//
//    // ── All Sessions (no date filter — legacy/fallback) ─────────────
//    public List<DashboardResponse.SessionDto> findSessions() {
//        String sql =
//                "SELECT " +
//                        "    bs.id, bs.phone, bs.current_step, bs.is_active, " +
...
//    }
//
//    // ── Flow-wise Sessions (no date filter — legacy) ─────────────────
//    public List<DashboardResponse.SessionDto> findSessionsByFlow(String flow) {
//        String likePattern = flowToPattern(flow);
//        String sql =
//                "SELECT " +
...
//    }
//
//    // ── All Leads (no date filter — legacy) ──────────────────────────
//    public List<DashboardResponse.LeadDto> findLeads() {
//        try {
//            String sql =
//                    "SELECT " +
...
//    }
//
//    // ── Flow-wise Leads (no date filter — legacy) ────────────────────
//    public List<DashboardResponse.LeadDto> findLeadsByFlow(String flow) {
//        try {
//            String likePattern = flowToPattern(flow);
//            String sql =
...
//    }
//
//    // ── Flow Counts (Left Menu — no date filter) ─────────────────────
//    public Map<String, Long> findFlowCounts() {
//        String sql =
//                "SELECT " +
//                        "    SUM(CASE WHEN current_step LIKE 'BIRTHDAY_T10_%'     THEN 1 ELSE 0 END) AS bday_t10, " +
...
//    }
//
//    // ── Activity Feed (All flows, no date filter — legacy) ───────────
//    public List<DashboardResponse.ActivityEventDto> findRecentActivity() {
//        return findRecentActivityByFlow(null);
//    }
//
//    // ── Activity Feed (Flow-wise, no date filter — legacy) ───────────
//    public List<DashboardResponse.ActivityEventDto> findRecentActivityByFlow(String flow) {
//        String stepFilter;
//        Object[] params;
//
...
//        }
//
//        // ← button_payload ki shart hata di — har activity dikhegi
//        String sql =
//                "SELECT " +
//                        "    m.phone, m.direction, m.message_content, " +
//                        "    m.button_payload, m.sent_at, " +
...
//    }
//
//    // ── Activity Feed — Flow + Date-range wise ───────────────────────
...
//
//        try {
//            return jdbcTemplate.query(sql, new Object[]{pattern, from, to}, (rs, rowNum) -> {
//                String name      = defaultIfBlank(safe(rs, "customer_name"), "WhatsApp User");
//                String direction = safe(rs, "direction");
//                String payload   = safe(rs, "button_payload");
//                String content   = safe(rs, "message_content");
...
//    }
//
//    // ── Hourly Messages (always today, chart-specific) ───────────────
//    public Map<Integer, Map<String, Long>> findMessageCountsToday() {
//        String sql =
//                "SELECT HOUR(sent_at) AS hour_value, direction, COUNT(*) AS total " +
//                        "FROM messages " +
...
/**
 * Data access layer — SAARI native SQL yahin hoti hai.
 * Koi business logic / calculation yahan nahi hota — sirf DB se data laana
 * aur ResultSet ko DTO mein map karna.
 */
@Slf4j
@Repository
@RequiredArgsConstructor
