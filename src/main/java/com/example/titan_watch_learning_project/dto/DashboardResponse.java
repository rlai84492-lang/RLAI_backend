...
public class DashboardResponse {
    ...
    // ── Paginated lists (capped at MAX_SESSION_ROWS / MAX_LEAD_ROWS) ─
    private List<SessionDto> sessions;
    private List<LeadDto>    leads;

    // ── TRUE totals from COUNT(*) — not list.size() ──────────────────
    // These are what you show in the UI tiles and "X total" labels.
    // Even if sessions list only has 500 items, totalSessions may be 29132.
    ...
    public static class SessionDto {
        ...
        private String  customerName;
        private String  phone;
        private String  currentStep;          // raw step from DB
        private String  rawStep;              // same — backward compat
        private String  flow;                 // bday_t10 | bday_t0 | anniv_t10 | anniv_t0
        private String  selectedCollection;
        private String  selectedBrand;
        private String  selectedStyle;
        private Boolean isActive;
        private String  lastActivity;         // ISO string
    }
